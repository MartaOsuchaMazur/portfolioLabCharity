...
<%--        <form action="form-confirmation.html" method="post">--%>
            ...
            <div data-step="1" class="active">
                ...
                <div class="form-group form-group--checkbox">
                    <label>
                        <form:checkbox path="categories" value="${category.id}" id="${category.name}"/>
<%--                                       type="checkbox" name="categories" value="${category.id}" id="${category.name}"/>--%>
            ...
            <div data-step="3">
                ...
                <div class="form-group form-group--checkbox">
                    <label>
                        <form:radiobutton path="institution" value="${institution.id}" title="${institution.name}" id="institution.description"/>
<%--                        <input type="radio" name="institution" value="old" />--%>
                        <span class="checkbox radio"></span>
                        <span class="description">
                  <div class="title">Fundacja ${institution.name}</div>
                  <div class="subtitle">Cel i misja: ${institution.description}</div></span>
                    </label>
                </div>
                    </c:forEach>
            ...
            <div data-step="4">
                ...
                <div class="form-section form-section--columns">
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            <label>Numer telefonu <form:input path="phone" type="phone" name="phone" />
                    ...
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            <label>Uwagi dla kuriera<form:textarea path="pickUpComment" name="pickUpComment" rows="5"/></label>
